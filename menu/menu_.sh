...
echo -e "${IBlue} │${NC} $bd Use Core   : ${NC}Multi Lite${NC}"
...
echo -e "            ${BIBlue} ════════════════════════════${NC}"
echo -e "    ${NC}             ${NC}[${NC}01${NC}] SSH     ${NC}  [${NC}Menu${NC}]${NC}"
echo -e "    ${NC}             ${NC}[${NC}02${NC}] VMESS   ${NC}  [${NC}Menu${NC}]${NC}"
echo -e "    ${NC}             ${NC}[${NC}03${NC}] VLESS   ${NC}  [${NC}Menu${NC}]${NC}"
echo -e "    ${NC}             ${NC}[${NC}04${NC}] TROJAN  ${NC}  [${NC}Menu${NC}]${NC}"
echo -e "    ${NC}             ${NC}[${NC}05${NC}] SETING  ${NC}  [${NC}Menu${NC}]${NC}"
echo -e "    ${NC}             ${NC}[${NC}01${NC}] TRIAL   ${NC}  [${NC}Menu${NC}]${NC}"
echo -e "    ${NC}             ${NC}[${NC}07${NC}] BACKUP   ${NC} [${NC}Menu${NC}]${NC}"
